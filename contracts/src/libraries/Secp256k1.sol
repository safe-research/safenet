...
library Secp256k1 {
     ...
     *      parameter of the curve, as specified in standards like "SEC 2: Recommended
     ...
     *      prime number. Its value is 2^256 - 2^32 - 977 as specified in standards.
     */
     ...
     * @dev This is a large prime number that specifies the number of distinct points
     *      that can be generated by repeatedly adding the generator point to itself.
     *      All scalar multiplications are performed modulo N.
     */
