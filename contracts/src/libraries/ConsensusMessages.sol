 ...
 * @notice Library for computing consensus messages that are signed by the
 *         validator set.
 */
library ConsensusMessages {
    ...
    /**
     * @notice Computes the epoch rollover message that must be signed by the
     *         active group.
    ...
    /**
     * @notice Computes the transaction proposal message that must be attested
     *         to by validators.
     * @param domainSeparator The EIP-712 domain separator.
