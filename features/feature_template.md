# Feature Proposal: Short feature name
Component: impacted workspace (i.e. `explorer` or `all`)
...
If user interaction is part of the feature, outline the different user flows
