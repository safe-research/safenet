...
import { bindingFactors, bindingPrefix, generateNonce, type NonceCommitments } from "./nonces.js";
...
describe("nonces", () => {
	...
	it("should correctly encode binding prefix", () => {
	...
	it("should generate correct binding factors", () => {
