...
describe("hashes", () => {
	...
	it("should generate a valid key gen challenge", () => {
		...
		const r = toPoint({
			x: BigInt(
				"0x8a3802114b5b6369ae8ba7822bdb029dee0d53fc416225d9198959b83f73215b",
			),
			y: BigInt(
				"0x3020f80cae8f515d58686d5c6e4f1d027a1671348b6402f4e43ce525bda00fbc",
			),
		});
		const hash = keyGenChallenge(1n, ga0, r);
		expect(hash).toBe(
			BigInt(
				"0xe39fcb3eef980ce5ee77898a6ed247fe78146aca2852ca4cf9f7fdcf23b4d470",
			),
		);
	});
});
